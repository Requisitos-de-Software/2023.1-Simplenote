...
Este documento é destinado para a revisão do [Glossário](https://github.com/Requisitos-de-Software/2023.1-Simplenote/blob/main/docs/elicitacao/glossario.md) 
...
|  9  | As metodologias do texto definem de forma condizente as formas e os métodos que o grupo realizou o artefato?   |  não	  |     não existe metodologia no artefato      | [3](#ancora1) |
|  10  | O glossário foi bem definido? |  sim	  |           | [3](#ancora1) |
|  11  | Foi explicado o que cada termo significa dentro do aplicativo?   |  sim	  |           | [3](#ancora1) |
|  12  | Foram definidos requisitos a partir do glossário?                        |  sim	  |              | [3](#ancora1) |
|  13  | Os requisitos foram classificados corretamente?                        |  sim	  |         | [3](#ancora1) |
|  14  | São apresentados requisitos que não foram implementados?                        |  não	  |   não é citado no texto     | [3](#ancora1) |
...
Não existe metodologia no artefato

### ID 14 - São apresentados requisitos que não foram implementados?                        

Não existe nada no texto citando isso

## Sugestões


* Corrigir a referência do texto
* Criar uma seção de metodologia no artefato
* Citar requisitos não implementados  
...
> 
> [3] https://github.com/Requisitos-de-Software/2023.1-Caesb/blob/main/docs/Verificacao/Grupo5/Entrega2/elicitacao/glossario.md
> 
