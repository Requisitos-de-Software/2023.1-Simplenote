...
| **Rotina**         | Enzo acorda cedo para dar aula na escola em que trabalha nas segundas quartas e sextas pela manhã. Pela tarde, de segunda à sexta ele se encontra na Universidade de São Paulo para trabalhar em seus projetos de pesquisa e nas aulas das disciplinas de mestrado. |
| **Relacionamentos** | Alunos das turmas da qual leciona. </br> Seu irmão Daniel, que compartilha um apartamento com ele no centro de São Paulo </br> Júlia e Alexandre, seus amigos de faculdade. </br> Paulo, um amigo que trabalha como professor na escola em que trabalha.  |
| **Requisitos**      | Enzo prefere um aplicativo simples para facilitar a comunicação e compartilhamento. Normalmente pensa: </br> "Preciso de um aplicarivo com iinterface simples para motivar os alunos a usarem-no" </br> "Preciso que o aplicativo seja capaz de compartilhar anotações para facilitar o estudo dos alunos e facilitar meus estudos na faculdade e minha pesquisa"|
| **Frequência** | Utiliza o aplicativo quase que diariamente| 
| **Necessidades** | Estudos, trabalhos, compartilhar com colegaas de faculdade e seus alunos|
| **Expectativas**    | Enzo espera que o aplicativo seja intuitivo e prático. Seus pensamento sobre isso são: </br> "Conseguirei melhorar meus estudos de mestrado" </br> "Conseguirei melhorar meu desempenho na pesquisa" </br> "Conseguirei melhorar o entendimento dos meus alunos sobre o conteúdo" |
